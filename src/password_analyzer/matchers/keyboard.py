...
KeyboardMatch = Optional[dict]


# Standard QWERTY keyboard layout.
#
# Each row is represented independently so that a sequence
# does not cross from one keyboard row to another.
KEYBOARD_ROWS = (
    "1234567890",
    "qwertyuiop",
    "asdfghjkl",
...
def find_keyboard_pattern(
    password: str,
    min_length: int = 3,
) -> KeyboardMatch:
    """
    Find a consecutive keyboard pattern in a password.
    ...
    best_match: Optional[KeyboardMatch] = None
